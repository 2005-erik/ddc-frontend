  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-6 py-20">
        ...
        {/* Тезис миссии */}
        <p className="max-w-4xl text-2xl font-semibold leading-snug text-white sm:text-3xl">
        ...
        <div className="mt-14 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5">
          {values.map(({ icon: Icon, label }) => (
            <div
              key={label}
              className="group flex flex-col items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-4 py-6 text-center transition-all duration-300 hover:-translate-y-1 hover:border-nbk-gold/50 hover:shadow-[0_0_24px_rgba(255,215,0,0.15)]"
            >
